========================================================================
		ActiveX Control DLL : CZGOCX
========================================================================

ControlWizard has created this project for your CZGOCX ActiveX Control
...
that make up your CZGOCX ActiveX Control DLL.
...
CzgocxCtl.h
	This file contains the declaration of the CCzgocxCtrl C++ class.

CzgocxCtl.cpp
	This file contains the implementation of the CCzgocxCtrl C++ class.

CzgocxPpg.h
	This file contains the declaration of the CCzgocxPropPage C++ class.

CzgocxPpg.cpp
	This file contains the implementation of the CCzgocxPropPage C++ class.

CzgocxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCzgocxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file czgocx.rc.
