...
namespace pstndemo
{
	...
	public const int BCERR_WRITESTOREAGEERR	=-47; //写入存储错误
	public const int BCERR_NOTSUPPORTCHECK	=-48; //通道不支持线路检测功能
	public const int BCERR_INVALIDPATH=-49; //不合法的文件路径
	public const int BCERR_AUDRVINSTALLED=-50; //虚拟声卡驱动已经安装
	public const int BCERR_AUDRVUSEING=-51; //虚拟声卡正在使用不能覆盖,请退出正在使用该驱动的软件或者重新启动电脑再安装
	public const int BCERR_AUDRVCOPYFAILED=-52; //虚拟声卡驱动文件复制失败
